...
window.app = {
  ...
  copy: null,
  clipboard: null,
  createCopyButton: function createCopyButton(clipboardTarget) {
  ...
  onLoad: function onLoad(e) {
    window.app.examples = Array.prototype.slice.call(document.querySelectorAll('pre > code'));
    window.app.initExamples();
    var anchors = new (anchor_js__WEBPACK_IMPORTED_MODULE_1___default())(window.app.options.anchors);
    anchors.add(window.app.options.anchors_add);
    tocbot__WEBPACK_IMPORTED_MODULE_4___default().init(window.app.options.tocbot);
  },
  options: {
