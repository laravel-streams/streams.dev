<div class="px-20 py-16">
    ...
    {{-- <div class="mt-16 space-x-4">
        <a href="/explore" class="px-6 py-3 rounded-3xl font-bold text-2xl bg-black hover:bg-gray-800 text-white outline-none focus:outline-none hover:shadow-md transition duration-200 ease-in-out">Explore</a>
    </div> --}}
